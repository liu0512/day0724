...
import com.bawei.repository.DepartRepository;
...
public class UserServiceImpl implements UserService {
    ...
    @Override
    public MyPageImpl list(UserVo userVo) {
        ...
        // 生成分页的对象  符合国人习惯
        Pageable pageable = PageRequest.of(userVo.getCurrent() - 1, userVo.getSize(), Sort.Direction.DESC, "uid");
